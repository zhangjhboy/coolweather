...
public class WeatherActivity extends AppCompatActivity {
    ...
    /**
     * 根据{@code weatherId}请求天气信息
     * @param weatherId 天气id
     */
    private void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=362181e9ee8641eb98e81b5bf7b5adce";
    ...
    /**
     * 处理并展示{@link Weather}实体类中的数据
     * @param weather {@link Weather}实体类
     */
